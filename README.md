...
476 座開在真實位置、掛著真實編號的出入口、20 座轉乘站的轉乘通道、
...
187 座站體共 **476 座出入口**（471 座折返式樓梯井、5 座平面出入口；含複合體裡
...
接不上的 20 個各有理由，報表會印：撞到別的井或通道 12（其中 4 個是複合體
退回來的）、通道會露出地面 4、撞到別線的結構 2（北投的兩個，正下方是
...
全網 476 座全部走得到月台、門也全部開在街上，22 座轉乘站的出入口各自全在
同一團裡。
...
- 476 座出入口以外還有 20 個接不上（理由見「真實出入口」，其中 4 個是
  複合體裡地下街也接不上的）
